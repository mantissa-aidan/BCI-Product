...
wandb.init(project="left-right-voice-recognition")

from keras.callbacks import ModelCheckpoint, EarlyStopping

es = EarlyStopping(monitor='acc', mode='max', verbose=1)
	
mc = ModelCheckpoint("left-right-192.h5", monitor='val_acc', mode='max', verbose=1, save_best_only=True)
